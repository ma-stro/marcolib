...
irfq1 = 20.314		; from a model described in Chant
irfq2 = 9.007
irfq3 = 0.851
irfq4 = 20.271
irfq5 = 8.937
...
goon:
;OUTBEG
ipanmin		= (p20*0.5)+0.5	; scale -1/1 to 0/1
ipanmax		= (p21*0.5)+0.5	; scale -1/1 to 0/1
ipandev		= ipanmax-ipanmin
ipanenv		= p22
ipandur		= (p23 = 0.0 ? idurosc : 1/p23)
...
;OUTBEG
		...
		;--- Panning ---
		;    ---------
kpan	poscil3	ipandev, ipandur, ipanenv
kpan	=	kpan+ipanmin
aut1, aut2	pan2	asound, kpan, ipanmode
