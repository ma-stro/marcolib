  ...
  (
   ( source-code :initform
                 (load-buffer-textfile
                  (get-orc-source (get-orc "ad1t"))
                  'textfile "append")
                 :allocation :class
                 :type textfile
                 :accessor source-code)
   ( numchan :initform (or (get-orc-channels (get-orc "ad1t")) 1)
...
(defclass! ad1t
  ...
  (:documentation
   "
Extension of the instrument ADD1s, class ad1t-rt.
...
(defmethod get-slot-in-out-names ((self ad1t))
...
(defmethod fixed-slots-list ((x om::ad1t))
