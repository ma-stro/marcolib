  ...
  (
   ( source-code :initform
                 (load-buffer-textfile
                  (get-orc-source (get-orc "ad1v"))
                  'textfile "append")
                 :allocation :class
                 :type textfile
                 :accessor source-code)
   ( numchan :initform (or (get-orc-channels (get-orc "ad1v")) 1)
...
;=============================================================================
;		AD1v.ORC
; ADDITIVE SYNTHESIS INSTRUMENT N. 11 / COMPLETE / TRIAPHONIC (no ch. 3)
;=============================================================================
...
(defclass! ad1v
  ...
  (:documentation
   "
Extension of the instrument ADD1s, class ad1v-rt.
...
(defmethod get-slot-in-out-names ((self ad1v))
...
(defmethod fixed-slots-list ((x om::ad1v))
