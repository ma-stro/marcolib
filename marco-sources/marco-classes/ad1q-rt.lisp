  ...
  (
   ( source-code :initform
                 (load-buffer-textfile
                  (get-orc-source (get-orc "ad1q"))
                  'textfile "append")
                 :allocation :class
                 :type textfile
                 :accessor source-code)
   ( numchan :initform (or (get-orc-channels (get-orc "ad1q")) 1)
...
(defclass! ad1q
  ...
  (:documentation
   "
Extension of the instrument ADD1s, class ad1q-rt.
...
(defmethod get-slot-in-out-names ((self ad1q))
...
(defmethod fixed-slots-list ((x om::ad1q))
