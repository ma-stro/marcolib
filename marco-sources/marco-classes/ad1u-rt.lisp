  ...
  (
   ( source-code :initform
                 (load-buffer-textfile
                  (get-orc-source (get-orc "ad1u"))
                  'textfile "append")
                 :allocation :class
                 :type textfile
                 :accessor source-code)
   ( numchan :initform (or (get-orc-channels (get-orc "ad1u")) 1)
...
;=============================================================================
;		AD1u.ORC
; ADDITIVE SYNTHESIS INSTRUMENT N. 11 / COMPLETE / TRIAPHONIC (no ch. 2)
;=============================================================================
...
(defclass! ad1u
  ...
  (:documentation
   "
Extension of the instrument ADD1s, class ad1u-rt.
...
(defmethod get-slot-in-out-names ((self ad1u))
...
(defmethod fixed-slots-list ((x om::ad1u))
