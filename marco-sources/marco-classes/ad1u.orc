...
if ((kpan >= 0.0) && (kpan < 120.0)) goto quad1
if ((kpan >= 120.0) && (kpan < 240.0)) goto quad2
aut4, aut1	pan2	asound, ((kpan % 120.0) / 120.0), ipanmode
goto end

quad1:
aut1, aut3	pan2	asound, (kpan / 120.0), ipanmode
goto end

quad2:
aut3, aut4	pan2	asound, ((kpan % 120.0) / 120.0), ipanmode

end:
aut2	= 0.0
		outc	aut1*idist+asound*(1-idist), \
				aut2, \
				aut3*idist+asound*(1-idist), \
				aut4*idist+asound*(1-idist)
;OUTEND
